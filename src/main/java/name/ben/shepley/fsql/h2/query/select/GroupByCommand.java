...
public class GroupByCommand extends NestedBuilder<H2Select> implements SqlParameter {
    private Map<String, Object> queryParameters;

    public GroupByCommand(H2Select h2Select, Map<String, Object> queryParameters) {
        super(h2Select);
