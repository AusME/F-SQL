...
public class HavingCommand extends NestedBuilder<H2Select> implements SqlParameter {
    private Map<String, Object> queryParameters;

    public HavingCommand(H2Select h2Select, Map<String, Object> queryParameters) {
        super(h2Select);
