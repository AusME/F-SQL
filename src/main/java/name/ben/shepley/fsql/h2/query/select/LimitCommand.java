...
public class LimitCommand extends NestedBuilder<H2Select> implements SqlParameter {
    private Map<String, Object> queryParameters;

    public LimitCommand(H2Select h2Select, Map<String, Object> queryParameters) {
        super(h2Select);
